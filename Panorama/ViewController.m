...
- (void)setupButtons {
    ...
    [panoramaView addButton:button4 toAngleDegrees:180];
    ...
    [panoramaView addButton:button5 toAngleDegrees:45];
    ...
    [panoramaView addButton:button6 toAngleDegrees:-45];
    ...
    [panoramaView addButton:button7 toAngleDegrees:135];
    ...
    [panoramaView addButton:button8 toAngleDegrees:-135];
}
